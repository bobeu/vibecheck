...
// Re-export mock cUSD utilities from the contracts file
// The actual contract details are stored in @/contracts/mockCUSD.ts
// export { getMockCUSDAddress, getMockCUSDConfig } from '@/contracts/mockCUSD';